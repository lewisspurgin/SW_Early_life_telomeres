...
table1 <- rbind(c('A',rep(' ',4)),table1A,c('--',rep(' ',4)),c('B',rep(' ',4)),table1B)
table1[,3:5] <- lapply(table1[,3:5],as.numeric)
table1[,3:5] <- round(table1[,3:5],3)
table1[,3:5] <- lapply(table1[,3:5],as.character)
table1[is.na(table1)] <- " "
