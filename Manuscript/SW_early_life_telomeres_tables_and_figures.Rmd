...
```{r Figure 4}
dd14$r <- sample(1:nrow(dd14),replace = F)
temp <- dd14[order(dd14$BirdID,dd14$r,decreasing = F),] %>%
...
x <- subset(dd14,Fledged == 'Fledglings')

table(x$Sex,x$LayYear)

dd14$SexAge <- paste(dd14$Fledged,dd14$Sex)

ggplot(dd14,aes(x = Tarsus,y = RTL,col = SexAge))+
