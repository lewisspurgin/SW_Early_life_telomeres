...
**Figure 2** Temporal variation in early-life telomere dynamics in the Seychelles warbler based on cross-sectional **(A)** and longitudinal **(B)** data (see Fig. 1 and main text for details). Points and error bars represent mean and standard error telomere length for all birds born in each main (black) or minor (grey) breeding season, in relation to island-wide food availability. Trend lines represent fitted values from a linear regression.
