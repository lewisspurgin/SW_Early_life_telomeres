...
Email: L.Spurgin@uea.ac.uk
Web: lewisspurgin.wordpress.com
...
Two of our main faindings are particularly striking and will, we hope, be of interest to your readers. Firstly, we find that cohort effects are the most important drivers of variation in telomere length in the Seychelles warbler population. This has important ramifications for how studies of natural populations interpret variaiton in teloemre length, as these are often based on a single timepoint. Our data suggest that telomere dynamics at a single point in time may in fact be a snapshot of a temporally dynamic process.
