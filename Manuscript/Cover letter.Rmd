...
Secondly, using a large number of repeated telomere measurements we show that within-individual increases in telomere length occure, and that these cannot be solely explained by measurement error. This is in accordance with recent theoretical work, and data from humans, suggesting that telomere elongation may be an ecologically important process. We hope that our data will spur further research into when, where any why telomere elongation occurs.
