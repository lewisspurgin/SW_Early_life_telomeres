...
##Data accessibility
This manuscript was written in R Markdown (http://rmarkdown.rstudio.com/). All data and scripts required to reproduce the manuscript, figures and analyses are available on GitHub (doi: 10.5281/zenodo.835844).
