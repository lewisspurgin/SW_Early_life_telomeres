...
RESPONSE: Positive skew in telomere length distribution is a widespread and uncontroversial phenomenon, and the causes are likely biological (see for example Golubev et al. 2003 J. Theor. Biol.; Hirt et al. 2014; J. Math. Biol.; ). Investigating the causes of this are outside the scope of our study, and we feel that a discussion of this would be an unnecessary distraction.
