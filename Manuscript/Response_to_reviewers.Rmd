...
RESPONSE: As stated in the discussion (lines XX), we feel that this is an important area for future research, and we hope that it will be a whole manuscript on its own. We are already pushing the page limit for Journal of Animal Ecology, so adding in an entire new set of analyses is just not possible.
