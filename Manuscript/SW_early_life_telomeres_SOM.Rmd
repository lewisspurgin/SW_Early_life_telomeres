...
**Table S1** Cohort sizes for each birth year of the Seychelles warbler dataset used in this study.
```{r Table S1}
...
**Table S4** Model selection table for analysis of factors affecting $\Delta$RTL in Seychelles warblers, using longitudinal data. Only models that remained in the top model set for model averaging (AICc $\leq$ 6 compared to the top model) are included here. TQ = territory quality.
